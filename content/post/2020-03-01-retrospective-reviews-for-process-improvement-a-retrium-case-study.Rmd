...
thumbnailImage: /img/Retro page header.png
...
## Introduction  
My team applied a new approach with great success to our performance retrospective last week.  The approach worked so well that I’m standing up and evangalising the approach for a wider range of teams than those like our's who apply Agile.  

## Retrospective Goals and Objectives  
The goal of our performance retrospective is to improve our systems and processes to drive business value.

The objectives or our retrospectives are to identify what from our previous sprint that worked well and what didn’t work well.  From this list of what worked well and didn’t work well, we determine action items for improving our systems and processes.
...
***
Once the 5 minutes had elapsed, our scrum master revealed other's contributions.  
...
At this point of the process, the "Continue" items probably need no further action; they are a "nice-to-have" acknowlegement of recent, significant improvements where the team deserves a pat on the back!
...
Retrospectives offer huge opportunities for the team in an obvious and not-so-obvious way:  

* They bring issues and opportunities out into the open for discussion;  
* They allow the team to discuss and agree on the likely business improvement opportunity;  
* They help the team to drive process improvement;  
* Not so obviously, run well, the retrospective brings the team together.  

A huge benefit of brainstorming and voting online is that gives everyone an equal voice; there is far less risk of assertive and forthright members of the group dominating the discussion.  Using Retrium allowed our group to cover substantial ground in a very short space of time.  Given the benefit returned from the modest licence cost ($29 USD / month / team as at Mar-20), the return on investment is clear.  An online tool, such as Retrium, brings the kind of value to retrospectives as email did to written correspondence.
